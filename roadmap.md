...
- [ ] Implement `NormalizedRow` + strict validation (Pydantic v2).
- [ ] Add gap-fill and `is_synthetic` handling in IO.
- [ ] Introduce unified FeatureEngine (offline/live parity).
...
- [ ] Directional score + spread/cooldown/concurrency risk filters.
